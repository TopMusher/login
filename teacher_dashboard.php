    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Students <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="teacher_stu.php">Your Students</a></li>
...
$sql = "SELECT id, fname, sname, email, pword, rewardpoints FROM students";
...
?>
    ...
    <td>
        ...
        <h4><center>Their current tasks: </center></h4>
  ...
  <!--Code for the right hand side margin-->
   ...
   <h2 style="margin-right: 60px; margin-top: 20px"><strong><u><center>Recent News!</center></u></strong></h2>
  ...
  <h4 style="margin-right: 60px"><center>*HEADS UP TO ALL TUTORS!*</center></h4>
  <h5 style="margin-right: 60px"><center></center></h5>
  </div>
